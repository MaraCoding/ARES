...
#define pump 52
int heaterTemp = 75; // this vairable controls the temperature heater will run at
//=======Pump Initialization============================
void pumpInit(){
pinMode(pump, OUTPUT);
}
...
//  Serial.println(average);
  ...
  error = heaterTemp - averageTemp; // this adjusts temperature in C
...
void incrementTempByTen(){
  heaterTemp = heaterTemp + 40;
}

void decreaseTempByTen(){
  heaterTemp = heaterTemp - 40;
}
