 ...
 */
/*
 * This file has been configured to debug LabVIEW
 * LidarInit and SetID Disabled
 * read_dual_sensors now increments horzDistance and vertdistance by 1 every function call and resets once the variables reach a count of 1000
 * Pecking function disabled
 */
#include "LIDARS.h"
#include <avr/io.h>
#include "Actuation.h"
...
void setup() {
         ...
         //liDARInit();
         //setID();
         lidarConfig(); //configures timers on to sample LiDAR every x ms
          //=====Configure Actuators============
          vertConfig();
          horzConfig();
          winchConfig();
          ...
          sensor_init(); //configures loadcell timer
